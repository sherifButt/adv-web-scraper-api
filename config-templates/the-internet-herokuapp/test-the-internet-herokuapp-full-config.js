// Test script for the the-internet-herokuapp-full-config.json configuration
...
async function testTheInternetHerokuappConfig() {
  // Renamed function for clarity
  try {
    console.log('Starting test of the-internet-herokuapp-full-config.json');

    // Read the configuration file
    const configPath =
      'config-templates/the-internet-herokuapp/the-internet-herokuapp-full-config.json';
...
// Run the test
testTheInternetHerokuappConfig() // Renamed function call
  .then(() => {
    console.log('Test completed successfully');
    process.exit(0);
  })
