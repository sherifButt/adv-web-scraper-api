...
async function testConfig() {
  ...
  try {
    ...
    if (
      ...
      logger.info(`
        SUCCESS: Test completed and ${result.result.menuItems.length} menu items extracted.
        `);
      success = true;
    } else {
      logger.error(
        'FAILURE:  Test did not complete successfully or menu items were not extracted correctly.'
      );
