// Test script for the zoopla-config.json configuration
import { chromium } from 'playwright';
import { NavigationEngine } from './src/navigation/navigation-engine.js';
import fs from 'fs';

async function testZooplaConfig() {
  try {
    console.log('Starting test of zoopla-config.json');
    
    // Read the configuration file
    const configPath = './zoopla-config.json';
